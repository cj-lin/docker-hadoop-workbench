...
# 
# ./make_docker_compose_yml.sh [hdfs] [hbase|phoenix] [yarn] [drill] [spark]
###
...
$docker_compose_services
  ...
  notebook:
    ...
    hostname: notebook.${network_name}
    build:
      context: ./notebook
      args:
        nbuid: 1000
    ...
    ports: ["8888:8888"]
    volumes:
    - ./development:/home/user/devel
    - /data/aiadm:/data/aiadm

  superset:
    container_name: superset
    networks: ["${network_name}"]
    hostname: superset.${network_name}
    build: ./superset
    ports: ["8088:8088"]
